package org.designpattern.behavior.iterator._03_java;
...
import org.designpattern.behavior.iterator._02_after.Board;
...
public class IteratorInJava {
	...
	public static void main(String[] args) throws FileNotFoundException, XMLStreamException {
		...
		// TODO Streaming API for XML(StAX), 이터레이터 기반의 API (읽고 쓸 수 있듬)
		// TODO Simple API for XML(SAX), 읽어들일 때 사용
